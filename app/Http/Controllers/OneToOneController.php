...
class OneToOneController extends Controller
{
    ...
    public function index(Request $request): View
    {
        $filters = $request->validate([
            ...
            'compose' => ['nullable', 'boolean'], // arrivo da profilo membro: apre modale di nuova richiesta
        ]);
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // Apre il pannello dettaglio sulla richiesta appena creata e mostra toast successo.
        $successMessage = $isBookable
            ? 'One-to-one prenotato! Lo slot e\' disponibile e senza conflitti.'
            : 'Richiesta one-to-one inviata. Il destinatario ricevera\' una notifica.';
