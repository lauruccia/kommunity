                                    ...
                                    <div class="mt-4 flex flex-wrap items-center gap-4">
                                        ...
                                        @if (!empty($receivedReferralsCount) && $receivedReferralsCount > 0)
                                            <span class="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-100">
                                                <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor"><path d="M9 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM17 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 0 0-1.5-4.33A5 5 0 0 1 19 16v1h-6.07ZM6 11a5 5 0 0 1 5 5v1H1v-1a5 5 0 0 1 5-5Z"/></svg>
                                                {{ $receivedReferralsCount }} {{ $receivedReferralsCount === 1 ? 'referenza ricevuta' : 'referenze ricevute' }}
                                            </span>
                                        @endif
                                    </div>
                                @endif
