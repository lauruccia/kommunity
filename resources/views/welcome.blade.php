...
<header class="site-header">
    <div class="km-wrap header-inner">
        ...
        <nav class="site-nav" aria-label="Navigazione principale">
            ...
            <a href="{{ route('login') }}" class="nav-accedi-mobile">Accedi →</a>
        </nav>
...
<section class="km-section"><div class="km-wrap split-grid"><div><h2 class="section-title" style="font-size:clamp(2rem,4vw,3.2rem)">Cosa dicono<br>i nostri utenti</h2><p class="section-copy">Professionisti e aziende che hanno già scelto di far parte di Kommunity.</p><a href="#community" class="btn btn-ghost" style="margin-top:1.75rem">Scopri la community →</a></div><div class="testi-grid">@foreach($testimonials as [$quote,$name,$role,$avClass])<article class="testi-card"><div class="stars">★★★★★</div><p class="testi-quote">“{{ $quote }}”</p><div class="testi-person"><span class="tp-av tp-av-{{ $avClass }}"></span><span><strong>{{ $name }}</strong><span>{{ $role }}</span></span></div></article>@endforeach</div></div></section>
