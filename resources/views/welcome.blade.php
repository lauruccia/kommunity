    ...
    <div class="km-wrap local-grid">
        <div>
            ...
            <div class="city-chips">
                ...
                @empty
                    @foreach(['Roma','Milano','Napoli','Torino','Bologna'] as $city)<span class="city-chip">{{ $city }}</span>@endforeach
                @endforelse
        ...
        <div class="map-wrap">
            <div class="italy-map-art" aria-hidden="true">
                ...
                <div class="map-city-card glass">
                    ...
                    <p style="font-size:.76rem;color:var(--muted);margin:.15rem 0">48 membri attivi</p>
