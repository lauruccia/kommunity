...
@php
    ...
    $translations = [
        'it' => [
            ...
            'join_eyebrow'   => 'Accesso su valutazione',
            'join_title'     => 'Chiedi di entrare in Kommunity',
            'join_text'      => 'Kommunity è a numero chiuso: professionisti e aziende, uno ad uno. Non ci si iscrive, ci si propone.',
            'join_presenter' => ':name potrà presentarti, ma sarai ammesso solo se la posizione richiesta sarà libera.',
            'join_btn'       => 'Proponiti ora',
            'f_name'         => 'Nome e cognome',
            'f_email'        => 'Email',
            'f_phone'        => 'Telefono',
            'f_type'         => 'Ti proponi come',
            'f_private'      => 'Privato / Professionista',
            'f_company'      => 'Azienda',
            'f_vat'          => 'Partita IVA',
            'f_vat_hint'     => 'Obbligatoria per le aziende',
            'f_profession'   => 'Professione / attività',
            'f_submit'       => 'Invia la tua proposta',
            'f_privacy'      => 'I dati saranno usati solo per valutare la proposta.',
            'join_success_title' => 'Proposta ricevuta',
        ...
        'en' => [
            ...
            'join_eyebrow'   => 'Admission by evaluation',
            'join_title'     => 'Ask to join Kommunity',
            'join_text'      => 'Kommunity is a closed-number community: professionals and companies, one by one. You don\'t sign up: you put yourself forward.',
            'join_presenter' => ':name can introduce you, but you\'ll be admitted only if the position you ask for is available.',
            'join_btn'       => 'Put yourself forward',
            'f_name'         => 'Full name',
            'f_email'        => 'Email',
            'f_phone'        => 'Phone',
            'f_type'         => 'You\'re putting yourself forward as',
            'f_private'      => 'Individual / Professional',
            'f_company'      => 'Company',
            'f_vat'          => 'VAT number',
            'f_vat_hint'     => 'Required for companies',
            'f_profession'   => 'Profession / business',
            'f_submit'       => 'Send your proposal',
            'f_privacy'      => 'Your data will only be used to evaluate your proposal.',
            'join_success_title' => 'Proposal received',
        ...
        'fr' => [
            ...
            'join_eyebrow'   => 'Accès sur évaluation',
            'join_title'     => 'Demandez à entrer dans Kommunity',
            'join_text'      => 'Kommunity est à nombre fermé : professionnels et entreprises, un par un. Ici on ne s\'inscrit pas : on se propose.',
            'join_presenter' => ':name pourra vous présenter, mais vous ne serez admis que si la position demandée est libre.',
            'join_btn'       => 'Proposez-vous',
            'f_name'         => 'Nom et prénom',
            'f_email'        => 'Email',
            'f_phone'        => 'Téléphone',
            'f_type'         => 'Vous vous proposez en tant que',
            ...
            'f_submit'       => 'Envoyer votre proposition',
            'f_privacy'      => 'Vos données ne seront utilisées que pour évaluer votre proposition.',
            'join_success_title' => 'Proposition reçue',
        ...
        'es' => [
            ...
            'join_eyebrow'   => 'Acceso por evaluación',
            'join_title'     => 'Pide entrar en Kommunity',
            'join_text'      => 'Kommunity es de número cerrado: profesionales y empresas, uno a uno. Aquí no te registras: te propones.',
            'join_presenter' => ':name podrá presentarte, pero solo serás admitido si la posición solicitada está libre.',
            'join_btn'       => 'Proponte ahora',
            'f_name'         => 'Nombre y apellidos',
            'f_email'        => 'Email',
            'f_phone'        => 'Teléfono',
            'f_type'         => 'Te propones como',
            'f_private'      => 'Particular / Profesional',
            'f_company'      => 'Empresa',
            'f_vat'          => 'NIF / IVA',
            'f_vat_hint'     => 'Obligatorio para empresas',
            'f_profession'   => 'Profesión / actividad',
            'f_submit'       => 'Enviar tu propuesta',
            'f_privacy'      => 'Tus datos solo se usarán para evaluar la propuesta.',
            'join_success_title' => 'Propuesta recibida',
        ...
        'de' => [
            ...
            'join_eyebrow'   => 'Aufnahme nach Prüfung',
            'join_title'     => 'Bitte um Aufnahme in Kommunity',
            'join_text'      => 'Kommunity ist eine geschlossene Community: Fachleute und Unternehmen, einzeln aufgenommen. Hier meldet man sich nicht an – man schlägt sich vor.',
            'join_presenter' => ':name kann dich vorstellen, aufgenommen wirst du aber nur, wenn die gewünschte Position frei ist.',
            'join_btn'       => 'Jetzt vorschlagen',
            'f_name'         => 'Vor- und Nachname',
            'f_email'        => 'E-Mail',
            'f_phone'        => 'Telefon',
            'f_type'         => 'Du schlägst dich vor als',
            'f_private'      => 'Privatperson / Freiberufler',
            'f_company'      => 'Unternehmen',
            'f_vat'          => 'USt-IdNr.',
            'f_vat_hint'     => 'Pflicht für Unternehmen',
            'f_profession'   => 'Beruf / Tätigkeit',
            'f_submit'       => 'Vorschlag senden',
            'f_privacy'      => 'Deine Daten werden nur zur Prüfung des Vorschlags verwendet.',
            'join_success_title' => 'Vorschlag erhalten',
        ...
        'ro' => [
            ...
            'join_eyebrow'   => 'Acces pe bază de evaluare',
            'join_title'     => 'Cere să intri în Kommunity',
            'join_text'      => 'Kommunity este cu număr închis: profesioniști și companii, unul câte unul. Aici nu te înscrii: te propui.',
            'join_presenter' => ':name te poate prezenta, dar vei fi admis doar dacă poziția cerută este liberă.',
            'join_btn'       => 'Propune-te acum',
            ...
            'f_submit'       => 'Trimite propunerea',
            'f_privacy'      => 'Datele vor fi folosite doar pentru evaluarea propunerii.',
            'join_success_title' => 'Propunere primită',
