                    ...
                    @if ($userPlanets->isNotEmpty())
                        ...
                        <div class="mt-3" x-data="{
                            ...
                            <a :href="whatsappUrl" target="_blank" rel="noopener"
                               class="mt-2 flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-white transition"
                               style="background:#25D366;"
                               onmouseover="this.style.background='#1ebe5e'"
