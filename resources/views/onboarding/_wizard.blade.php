    ...
    <div class="relative w-full max-w-xl overflow-hidden"
        ...
        <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0" class="px-7 pb-8 pt-4">
            ...
            <div style="margin-top:1.5rem;display:flex;gap:.75rem;">
                ...
                <button @click="next()" :disabled="saving" style="flex:1;padding:.8rem;border-radius:.9rem;background:linear-gradient(135deg,#8BC53F,#5f9d42);color:#061018;font-weight:900;font-size:.9rem;border:0;cursor:pointer;transition:.2s;"
                        :style="saving ? 'opacity:.6;cursor:not-allowed' : ''">
                    <span x-show="!saving">Avanti →</span>
