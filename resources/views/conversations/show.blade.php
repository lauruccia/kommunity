            ...
            <aside class="km-chat-panel km-chat-list flex min-h-0 flex-col">
                <div class="border-b border-white/[.08] p-4">
                    ...
                    <div class="mt-4 flex items-center gap-2 text-xs font-black">
                        ...
                        <a href="{{ route('conversations.index', ['filter' => 'favorites']) }}" class="{{ $activeFilter === 'favorites' ? 'km-cta-primary' : 'km-cta-secondary' }} px-3 py-2">Preferiti</a>
                    </div>
                </div>
            ...
            <section class="km-chat-panel km-chat-main flex min-h-0 flex-col">
                <header class="flex items-center justify-between border-b border-white/[.08] px-4 py-3 sm:px-5">
                    <div class="flex min-w-0 items-center gap-3">
                        <a href="{{ route('conversations.index') }}" class="km-chat-action md:hidden" aria-label="Torna ai messaggi">
                    ...
                    @empty
                        <div class="flex h-full items-center justify-center text-center">
                            <div>
                                ...
                                <p class="mt-2 text-sm text-white/55">Scrivi il primo messaggio per iniziare.</p>
                            </div>
                        </div>
                    @endforelse
